...
function checkPay() {
  if (document.getElementById("checkbox_right").checked) {
    checkbox_right_text.innerHTML =
      "Оплатить " + document.getElementById("all").innerHTML + " ком";
...
let cart = {
  tshirt: {
    ...
    priceaftersale:
      document.getElementById("priceaftersale").innerHTML /
      document.getElementById("counter").innerHTML,
    priceafter:
      document.getElementById("counter").innerHTML *
      (document.getElementById("price1").innerHTML /
  ...
  phone: {
    ...
    priceaftersale:
      document.getElementById("priceaftersale2").innerHTML /
      document.getElementById("counter2").innerHTML,
    priceafter:
      document.getElementById("counter2").innerHTML *
      (document.getElementById("price2").innerHTML /
  ...
  pen: {
    ...
    priceaftersale:
      document.getElementById("priceaftersale3").innerHTML /
      document.getElementById("counter3").innerHTML,
    priceafter:
      document.getElementById("counter3").innerHTML *
      (document.getElementById("price3").innerHTML /
...
const plusFunction = (id) => {
  ...
  if (id == "tshirt") {
    if (cart[id]["count"] < cart[id]["countall"]) {
      ...
      cart[id]["priceaftersalesfter"] =
        cart[id]["count"] * cart[id]["priceaftersale"];
    ...
    if (cart[id]["count"] < cart[id]["countall"]) {
      ...
      cart[id]["priceaftersalesfter"] =
        cart[id]["count"] * cart[id]["priceaftersale"];
      document.getElementById("price2").innerHTML = Math.round(
        cart[id]["priceafter"]
      )
        .toString()
        .replace(/\B(?=(\d{3})+(?!\d))/g, " ");
      document.getElementById("priceaftersale2").innerHTML = Math.round(
        cart[id]["priceaftersalesfter"]
      )
        .toString()
        .replace(/\B(?=(\d{3})+(?!\d))/g, " ");
...
const minusFunction = (id) => {
  ...
  if (id == "tshirt") {
    if (cart[id]["count"] >= 1) {
      ...
      cart[id]["priceaftersalesfter"] =
        cart[id]["priceaftersalesfter"] - cart[id]["priceaftersale"];
      document.getElementById("price1").innerHTML = cart[id]["priceafter"];
      document.getElementById("counter").innerHTML = cart[id]["count"];
      document.getElementById("priceaftersale").innerHTML =
        cart[id]["priceaftersalesfter"];
    ...
    if (cart[id]["count"] >= 1) {
      ...
      cart["pen"]["priceaftersalesfter"] =
        cart["pen"]["count"] * cart["pen"]["priceaftersale"];
      cart[id]["count"]--;
      cart[id]["priceafter"] = cart[id]["priceafter"] - cart[id]["price"];
      cart[id]["priceaftersalesfter"] =
        cart[id]["priceaftersalesfter"] - cart[id]["priceaftersale"];
    ...
    if (cart[id]["count"] >= 1) {
      cart["phone"]["priceafter"] =
        cart["phone"]["count"] * cart["phone"]["price"];
      cart["phone"]["priceaftersalesfter"] =
        cart["phone"]["count"] * cart["phone"]["priceaftersale"];
      cart[id]["count"]--;
      cart[id]["priceafter"] = cart[id]["priceafter"] - cart[id]["price"];
      cart[id]["priceaftersalesfter"] =
        cart[id]["priceaftersalesfter"] - cart[id]["priceaftersale"];
...
const sumCart = (id) => {
  document.getElementById("all").innerHTML = Math.round(
    cart["tshirt"]["priceafter"] +
      cart["phone"]["priceafter"] +
      cart["pen"]["priceafter"]
  )
    .toString()
  ...
  document.getElementById("allaftersale").innerHTML = Math.round(
    cart["tshirt"]["priceaftersalesfter"] +
      cart["phone"]["priceaftersalesfter"] +
      cart["pen"]["priceaftersalesfter"]
  )
    .toString()
  ...
  document.getElementById("sale").innerHTML = (
    Math.round(
      cart["tshirt"]["priceafter"] +
        Math.round(cart["phone"]["priceafter"]) +
        cart["pen"]["priceafter"]
    ) -
    (cart["tshirt"]["priceaftersalesfter"] +
      Math.round(cart["phone"]["priceaftersalesfter"]) +
      cart["pen"]["priceaftersalesfter"])
  )
    .toString()
    .replace(/\B(?=(\d{3})+(?!\d))/g, " ");
...
function validate() {
  if (document.getElementById("checkbox_2").checked) {
    flag = 1;
    cart["tshirt"]["priceafter"] =
      cart["tshirt"]["count"] * cart["tshirt"]["price"];
    cart["tshirt"]["priceaftersalesfter"] =
      cart["tshirt"]["count"] * cart["tshirt"]["priceaftersale"];
    sumCart();
    count_icon();
  } else if (document.getElementById("checkbox_2").checked == false) {
    flag = 0;
    document.getElementById("shopCart-count").innerHTML =
      cart["tshirt"]["count"] - cart["tshirt"]["count"];
    document.getElementById("shopCart-count2").innerHTML =
      cart["tshirt"]["count"] - cart["tshirt"]["count"];
...
function del() {
  document.getElementById("price2").innerHTML = document
    .getElementById("price2")
    .innerHTML.toString()
    .replace(/\B(?=(\d{3})+(?!\d))/g, " ");
  document.getElementById("priceaftersale2").innerHTML = document
    .getElementById("priceaftersale2")
    .innerHTML.toString()
    .replace(/\B(?=(\d{3})+(?!\d))/g, " ");
}
del();
